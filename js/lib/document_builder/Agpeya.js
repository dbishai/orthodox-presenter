var Agpeya = {
    FirstHour: function (attributes) { //content for the first hour of the book of hours
        var docs = [];
    ...
    EleventhHour: function (attributes) {
        var docs = [];
    ...
    TwelfthHour: function (attributes) {
        var docs = [];
    ...
    Confession: function (attributes) {
        var docs = [];
